...
{
    Task<MonthlyContractDto> CreateAsync(CreateMonthlyContractRequest request, CancellationToken ct = default);
    Task<MonthlyContractDto> RenewAsync(Guid contractId, int additionalMonths, CancellationToken ct = default);
